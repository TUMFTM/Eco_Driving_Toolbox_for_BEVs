...
boundsx.lb_a = [ dm.a_init_lb; ones(m-2,1) * paramConstant.a_max_b] ;
boundsx.ub_a = [dm.a_init_ub; ones(m-2,1) * paramConstant.a_max_t];
...
disp('Bounds of state vector defined.')
